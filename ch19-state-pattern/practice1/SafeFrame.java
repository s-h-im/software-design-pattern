...
public class SafeFrame extends Frame implements Context { // ActionListener 삭제
    ...
    public SafeFrame(String title) {
        ...
        // 금고 사용 버튼 클릭 시 현재 상태에서 doUse 메서드 호출
        buttonUse.addActionListener(e -> state.doUse(this));
        // 비상벨 버튼 클릭 시 현재 상태에서 doAlarm 메서드 호출
        buttonAlarm.addActionListener(e -> state.doAlarm(this));
        // 일반 통화 버튼 클릭 시 현재 상태에서 doPhone 메서드 호출
